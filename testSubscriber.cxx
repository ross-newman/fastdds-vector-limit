...
testSubscriber::testSubscriber() : mp_participant(nullptr), mp_subscriber(nullptr) {}

testSubscriber::~testSubscriber() { Domain::removeParticipant(mp_participant); }
...
bool testSubscriber::init() {
  ...
  Rparam.topic.topicName = "testPubSubTopic";
...
void testSubscriber::SubListener::onNewDataMessage(Subscriber* sub) {
  ...
  if (sub->takeNextData(&st, &m_info)) {
    if (m_info.sampleKind == ALIVE) {
      ...
      ++n_msg;
      T_Payload payload = st.A_payload();
