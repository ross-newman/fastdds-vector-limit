...
#error Generated test is not compatible with current installed Fast-RTPS. Please, regenerate it with fastrtpsgen.
#endif

typedef char T_Char;
typedef std::vector<T_Char> T_Payload;
/*!
 * @brief This class represents the TopicDataType of the type I_Kit_Logging defined by the user in the IDL file.
 * @ingroup TEST
 */
class I_Kit_LoggingPubSubType : public eprosima::fastrtps::TopicDataType {
public:
    typedef I_Kit_Logging type;

    eProsima_user_DllExport I_Kit_LoggingPubSubType();

    eProsima_user_DllExport virtual ~I_Kit_LoggingPubSubType();
